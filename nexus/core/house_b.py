...
HOUSE_B_SYSTEM: str = (
    ...
    "- GOOD: \"Find one paid Python freelance gig posted on remoteok.com today\"\n"
    "- GOOD: \"Search weworkremotely.com for remote data-entry contracts\"\n"
    "- BAD:  \"Design a systematic process to identify and validate opportunities\"\n\n"
    "PLATFORM GUIDE — choose platforms accessible WITHOUT login (PREFER these first):\n"
    "  PREFER: remoteok.com (JSON API, no login), weworkremotely.com, "
    "remote.co/remote-jobs, indeed.com\n"
    "  OK: Craigslist gigs (craigslist.org/d/gigs), gun.io, "
    "fiverr.com/search, peopleperhour.com/projects\n"
    "  AVOID freelancer.com: redirects to login page before showing listings — "
    "browser agent gets stuck.\n"
    "  AVOID HackerNews: 'Who is Hiring' thread posts only once a month — "
    "no daily gig listings, not browsable for real-time opportunities.\n"
    "  AVOID Upwork: requires login to view full job listings — not browsable.\n"
    "  AVOID Toptal: invite-only, no public listings.\n\n"
    "If the input is 'find a gig' — output must be 'Find a gig on [specific accessible site]'.\n"
